...
interface IAdAgencyWalletSlice {
  loading: boolean;
  allApiStatus: {
...
const initialState: IAdAgencyWalletSlice = {
  loading: false,
  allApiError: {
    getBalance: "",
    getTransactions: "",
...
export const getBalance = createAsyncThunk(
  "adAgencyWalletSlice/getBalance",
...
export const getTransactions = createAsyncThunk(
  "adAgencyWalletSlice/getTransactions",
...
const adAgencyWalletSlice = createSlice({
  name: "adAgencyWalletSlice",
  initialState,
  reducers: {},
...
export default adAgencyWalletSlice.reducer;
