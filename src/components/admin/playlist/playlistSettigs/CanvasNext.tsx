...
import { calendar, users } from "../../assets/Index";
import Playlist from "../Playlist";
import Groups from "./Groups";
import { groupsStyles, playListSettingsStyles } from "./PlaylistSettingsStyles";
import Screens from "./Screens";
const tabs = ["Screen", "Groups", "Playlists", "Playlist schedule"];
  ...
  return (
    <Stack direction={"column"}>
      ...
      <Box sx={playListSettingsStyles.tabBox}>
        ...
        <Box sx={playListSettingsStyles.buttonsButton}>
          <CustomButton
            ...
            endIcon={
              <Box
                component={"img"}
                src={calendar}
                sx={playListSettingsStyles.headerIcon}
              />
            }
            bgcolor={colors.lightBlue}
            sx={playListSettingsStyles.headerBtns}
          >
            Schedule
          </CustomButton>
          <CustomButton
            ...
            sx={playListSettingsStyles.headerIconPublic}
          >
            Public
          </CustomButton>
        </Box>
