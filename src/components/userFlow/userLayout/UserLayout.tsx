...
import { getBalance } from "../../../redux/reducers/userReducers/myWalletSlice";
...
import AddNewCampaign from "../createCampaign/AddNewCampaign";
import Checkout from "../createCampaign/Checkout";
import ChooseLocation from "../createCampaign/ChooseLocation";
import ChooseScreenGroup from "../createCampaign/ChooseScreenGroup";
import ChooseSlots from "../createCampaign/ChooseSlots";
import MediaByGenre from "../createCampaign/MediaByGenre";
import PricingModel from "../createCampaign/PricingModel";
import SelectCategory from "../createCampaign/SelectCategory";
import SubCategory from "../createCampaign/SubCategory";
import UploadFiles from "../createCampaign/UploadFiles";
import {
  QontoConnector,
  QontoStepIconRoot,
  userLayoutStyles,
} from "./UserLayoutStyles";
type ValuePiece = Date | null;
export type Value = ValuePiece | [ValuePiece, ValuePiece];
export type DateArray = [ValuePiece, ValuePiece];
export interface UserLayoutIState {
  showScreens: boolean;
  errors: {
    campaignName: string;
    locationName: string;
...
export type UserLayoutCategoryType =
  | "selectedCategory"
  | "selectedSubCategory"
  | "selectedScreenGroup"
  | "selectedScreens";
export type UserLayoutFieldKey = "campaignName" | "adTypeId";
...
const UserLayout = () => {
  ...
  const [showScreens, setShowScreens] = useState<UserLayoutIState["showScreens"]>(false);
  ...
  const removeDuplicateOrAddNewItem = (key: UserLayoutCategoryType, id: string) => {
    const copyFormData = { ...form };
  ...
  const handleScreenSelection = (screenId: string) => {
    const copyFormData = { ...form };
    const selectedScreens = copyFormData["selectedScreens" as UserLayoutCategoryType];
        ...
        {campaign ? (
          ...
          <>
            <Header
              ...
              headerButton={
                isInAdsRoute && permission.create ? (
                  <CustomButton
