...
import {
  ...
  getOrderId,
  getTransactions,
} from "../../../redux/reducers/adAgencyReducers/adAgencyWallet";
...
const MyWallet = () => {
  ...
  const { allApiStatus, orderId, balance, transactions, pagination, loading } =
    useAppSelector((state) => state.adAgencyWallet);
