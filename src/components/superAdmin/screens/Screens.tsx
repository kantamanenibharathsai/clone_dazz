...
const Screens = () => {
  ...
  const handleUpdateGroup = () => {
    if (updateGroup.value) {
      ...
      setUpdateGroup({ ...updateGroup, error: "Please enter a name" });
    }
  };
  ...
  const handleSceenGroupSetting = (
    ...
    navigate(`/screens/settings/${groupName}/${screenGropuId}`);
  };
  return (
    <Box sx={screenStyles.mainContainer}>
      ...
      <ModalStyled open={groupModal} onClose={() => setGroupModal(false)}>
        <Stack
          direction={"column"}
          gap={2}
                        ...
                        <TableRow key={index}>
                          ...
                          <TableCell align="left">
                            <IconButton
                              ...
                              onClick={() =>
                                handleGroupModal(row.id, row.screenGroupName)
                              }
                            >
